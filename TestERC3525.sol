...
contract TestERC3525 is ERC3525 {
    ...
    constructor() ERC3525("Test ERC3525 Token", "TestERC3525", 1) {
    }
     ...
     function tokenURI(uint256 tokenId_) public view virtual override returns (string memory) {
        return string(
            abi.encodePacked(
                ...
                '</text>',
                '  <text xml:space="preserve" text-anchor="start" font-family="Noto Sans JP" font-size="24" id="svg_4" y="160" x="150" stroke-width="0" stroke="#000" fill="#ffffff"><marquee><div>ERC3252 Test Token</div></marquee></text>',
                ' </g> </svg>'
            )
        );
     }
